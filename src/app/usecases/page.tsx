...
import UsecasesContent from "@/components/sections/usecases/UsecasesContent";

export const metadata: Metadata = {
  title: "Case Studies & Use Cases | Edfoal",
  description: "Explore real AI engagements and case studies with measurable outcomes across enterprise operations, sales, and strategy.",
};
